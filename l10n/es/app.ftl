...
login-prompt = Inicie sesión para buscar firmware. Se abrirá su navegador.
login-button = Abrir navegador para iniciar sesión
...
history-no-results = No hay consultas coincidentes.
