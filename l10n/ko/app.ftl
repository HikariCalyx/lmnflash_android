...
retcn-read-current-device = 현재 기기에서 읽기
retcn-read-current-device-reading = 현재 기기 정보를 읽는 중…
retcn-read-current-device-complete = 기기 정보가 입력되었습니다. 펌웨어를 조회하기 전에 모든 값을 수정할 수 있습니다.
retcn-read-current-device-unsupported = 이 기능은 현재 기기에서 사용할 수 없습니다. Lenovo 및 Motorola 기기에서만 사용할 수 있습니다.
retcn-read-current-device-permission-denied = IMEI를 읽는 데 필요한 권한이 거부되었습니다. IMEI를 직접 입력하세요.