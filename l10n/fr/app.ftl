...
login-prompt = Connectez-vous pour rechercher un firmware. Votre navigateur s’ouvrira.
login-button = Ouvrir le navigateur pour se connecter
...
history-no-results = Aucune recherche correspondante.
