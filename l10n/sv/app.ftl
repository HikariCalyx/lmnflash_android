...
login-prompt = Logga in för att söka firmware. Din webbläsare öppnas.
login-button = Öppna webbläsaren för att logga in
...
history-no-results = Inga matchande sökningar.
history-clear = Rensa
history-close = Stäng
